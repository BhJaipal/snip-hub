...
import type { Button } from "../node_modules/@nuxt/ui/dist/runtime/types/button";
...
const config = {
	...
	title: "text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white tracking-tight pl-5",
	description: "mt-4 text-lg text-gray-500 dark:text-gray-400 text-left pl-5",
	icon: {
		wrapper: "flex",
